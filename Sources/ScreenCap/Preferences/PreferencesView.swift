    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 14) {
            ...
            Text(L10n.t("prefs.player.shortcuts.help"))
                ...
                .foregroundStyle(.secondary)
                .fixedSize(horizontal: false, vertical: true)
            shortcutRow("Space / K", L10n.t("prefs.player.shortcut.playPause"))
            ...
            shortcutRow("J / L", L10n.t("prefs.player.shortcut.medium"))
            shortcutRow("P / N", L10n.t("prefs.player.shortcut.previousNext"))
        }
        .padding(.vertical, 8)
        .padding(.horizontal, 12)
        .frame(maxWidth: .infinity, maxHeight: .infinity, alignment: .topLeading)
